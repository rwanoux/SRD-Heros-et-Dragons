...
Hooks.on("init", function() {
    game.settings.register("srd-heros-et-dragons", "showAll", {
        name: "montrer toutes les ressources",
        hint: "Toujours montrer toutes les ressources de classes sur la fiche de personnage.",
        scope: "client",
        config: true,
        default: false,
        type: Boolean,
    ...
    game.settings.srd
    game.settings.register("srd-heros-et-dragons", "globalLimit", {
    ...
    game.settings.register("srd-heros-et-dragons", "localLimit", {
    ...
    game.settings.register("srd-heros-et-dragons", "migratedLocalLimit", {
        config: false,
        scope: "client",
        default: false,
        type: Boolean,
    ...
    game.settings.register("srd-heros-et-dragons", "useNewSettingsLocation", {
    ...
    // check migration
    if (!game.settings.get("srd-heros-et-dragons", "migratedLocalLimit")) {
        if (game.settings.get("srd-heros-et-dragons", "localLimit") === 0) {
            game.settings.set("srd-heros-et-dragons", "localLimit", -1);
        }
        game.settings.set("srd-heros-et-dragons", "migratedLocalLimit", true);
    }
...
Hooks.on("renderActorSheet", function(dndSheet) {
    ...
    if (game.settings.get("srd-heros-et-dragons", "showAll")) {
        ...
        try {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if (resourceIndex == undefined) {
                    if (game.settings.get("srd-heros-et-dragons", "useNewSettingsLocation")) {
                        item.setAttribute("class", "attribute resource hidden");
                    } else {
